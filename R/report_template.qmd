...
# make region a factor and make the reference London - should be added to cleaning script
data <- data %>%
  mutate(
...
mod_1  <- glm(outsourcing_status ~ Age + Ethnicity_collapsed + BORNUK_labelled + Gender + Region + income_annual, data, family = "quasibinomial", weights = NatRepemployees)
summary(mod_1)
...
```{r}
sjPlot::tab_model(mod_1, mod_2, auto.label = FALSE)
```
