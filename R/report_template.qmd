...
[^'../outputs/sector_summary_paysplit_outsourcing_group.csv']
...
write_csv(sector_summary_paysplit, file="../outputs/sector_summary_paysplit_outsourcing_group.csv")
...
## Where are the UK's outsourced workers?[^18]
...
To visualise this differently, below we calculate the proportion of workers within each region who are outsourced. The plot can be read e.g., "~25% of workers in London are outsourced."[^outputs/data/region_stats_2.csv]
...
[^13]: "outputs/data/ethnicity_stats_paysplit_1.csv" and "../outputs/data/ethnicity_stats_paysplit_collapsed.csv"
...
### Ethnicity repeat: Outsourcing groups[^../outputs/data/ethnicity_stats_outsourcing_groups_1.csv]
...
#### Paysplit[^../outputs/data/bornuk_stats_paysplit_1.csv]
...
#### Paysplit[^../outputs/data/gender_stats_paysplit_1.csv]
