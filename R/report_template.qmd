...
The plot below shows the sector breakdown by outsourcing status. I.e. this is how outsourced and not outsourced workers are distributed across sectors.^["outputs/data/sector_summary.csv"]
...
#### Outsourcing status within sector^["outputs/data/sector_summary_3.csv"]
...
##### Apply the paysplit^["outputs/sector_summary_paysplit.csv"]
...
#### Paysplit^["outputs/data/ethnicity_stats_paysplit_1.csv"]
...
#### Outsourcing group^["outputs/data/age_stats_2.csv"]
