...
\[**Insert Name of Report**\] contains data from two studies. The first of these studies was a nationally representative survey of \[**Workers?**\] conducted by Opinium Research between \[**Month Year**\]. The total size of the sample is `r nrow(data)`. ADD INFORMATION ABOUT MEAN AGE, GENDER SPLIT and ETHNIC DIVERSITY AND POTENTIALLY POWER
...
-   Determining if the worker is outsourced
