...
difference_results_sig <- difference_results %>% 
  filter(significant_bonferroni == TRUE)
```

Post-hoc analysis indicates that:

- White British people are more likely to be in the low or mid income group, and less likely to be in the high income group, if they are outsourced compared to if they are not outsourced.
- People of mixed ethnicity are more likely to be in low income group if they are outsourced compared to if they are not outsourced
- People of 'other' ethnicity are more likely to be in low income group if they are outsourced compared to if they are not outsourced
...
ethnicity_diff_results_sig <- ethnicity_diff_results %>% 
  filter(significant_bonferroni == TRUE)
```

Comparing ethnicities within outsourcing status,

- Non-outsourced Asian workers are more likely to be in the mid income group, and less likely to be in the high income group, than non-outsourced White British workers.
- Non-outsourced people of 'other' ethnicity are less likely to be in the low income group than non-outsourced White British workers.
- Outsourced workers of mixed ethnicity are more likely to be in the low income group than White British outsourced workers.
