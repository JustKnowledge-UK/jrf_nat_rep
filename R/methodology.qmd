...
In this section we describe the statistical models used in the report.
...
Finally, we constructed a third generalised model predicting whether a person was outsourced based on disaggregated ethnicity groupings. The formula for this model is again:
