...
##### Pay as function of non-outsourced[^28]

[^28]: [outputs/data/sector_summary_pay_diff.csv)](https://github.com/Project-X-UK/jrf_nat_rep/tree/main/outputs/data/sector_summary_pay_diff.csv)
...
Exploring this as a proportion of the non-outsourced pay.[^30]

[^30]: [outputs/data/sector_summary_pay_diff_ogroup.csv](https://github.com/Project-X-UK/jrf_nat_rep/tree/main/outputs/data/sector_summary_pay_diff_ogroup.csv)
...
Although a model predicting income from outsourcing status and income group (controlling for other variables) indicates that pay does not depend on an interaction between a person's outsourcing status and income group, the plots below are informative in displaying variation by sector.[^31]

[^31]: [outputs/data/sector_summary_paysplit_o-status.csv](https://github.com/Project-X-UK/jrf_nat_rep/tree/main/outputs/data/sector_summary_paysplit_o-status.csv) & [outputs/data/sector_summary_paysplit_o-group_pay.csv](https://github.com/Project-X-UK/jrf_nat_rep/tree/main/outputs/data/sector_summary_paysplit_o-group_pay.csv)
...
The plot below shows the proportion of each major occupation group that is outsourced.[^32]

[^32]: [outputs/data/majorgroupcode_summary_o-status.csv](https://github.com/Project-X-UK/jrf_nat_rep/tree/main/outputs/data/majorgroupcode_summary_o-status.csv)
...
Below these proportions are further broken down by outsourcing group.[^33]

[^33]: [outputs/data/majorgroupcode_summary_o-group.csv](https://github.com/Project-X-UK/jrf_nat_rep/tree/main/outputs/data/majorgroupcode_summary_o-group.csv)
...
The plot below shows the average income by major occupation group.[^34]

[^34]: [outputs/data/majorgroupcode_summary_pay_overall.csv](https://github.com/Project-X-UK/jrf_nat_rep/tree/main/outputs/data/majorgroupcode_summary_pay_overall.csv)
...
Looking at absolute differences in pay by major occupation indicates that outsourced workers in most groups are paid less than non-outsourced workers.[^35]

[^35]: [outputs/data/mgc_summary_pay.csv](https://github.com/Project-X-UK/jrf_nat_rep/tree/main/outputs/data/mgc_summary_pay.csv)
...
##### Pay as function of non-outsourced[^36]

[^36]: [outputs/data/mgc_summary_pay_diff.csv)](https://github.com/Project-X-UK/jrf_nat_rep/tree/main/outputs/data/mgc_summary_pay_diff.csv)
...
Breaking this down by group indicates that there is variation between types of outsourcing in terms of pay. The 'outsourced' group is often (though not always) the least well-paid out of the outsourcing groups.[^37]

[^37]: [outputs/data/mgc_summary_pay_group.csv](https://github.com/Project-X-UK/jrf_nat_rep/tree/main/outputs/data/mgc_summary_pay_group.csv)
...
##### Pay as function of non-outsourced pay[^38]

[^38]: [outputs/data/mgc_summary_pay_diff_o-group.csv)](https://github.com/Project-X-UK/jrf_nat_rep/tree/main/outputs/data/mgc_summary_pay_diff_o-group.csv)
...
[^41]: [outputs/data/unit_occ_summary.csv](https://github.com/Project-X-UK/jrf_nat_rep/blob/main/outputs/data/unit_occ_summary.csv)
...
[^45]: [outputs/data/managers_unitoccs_summary_pay.csv](https://github.com/Project-X-UK/jrf_nat_rep/blob/main/outputs/data/managers_unitoccs_summary_pay.csv)
...
Breaking down by outsourcing group shows that most workers are outsourced in the 'Functional managers and directors' group, although a small number are likely agency.[^46]

[^46]: [outputs/data/o-group_managers_unitoccs_summary_pay.csv](https://github.com/Project-X-UK/jrf_nat_rep/blob/main/outputs/data/o-group_managers_unitoccs_summary_pay.csv)
...
The plot below indicates there are many unit occupations in this major occupation group where outsourced workers are paid less. The most notable of these are 'Information and Technology Technicians', 'Business Associate Professionals', and 'Sales, Marketing and Related Associate Professionals'.[^47]

[^47]: [outputs/data/assoc-prof_unitoccs_summary_pay.csv](https://github.com/Project-X-UK/jrf_nat_rep/blob/main/outputs/data/assoc-prof_unitoccs_summary_pay.csv)
...
The plot below shows that the pattern above is mainly driven by people in the 'outsourced' group.[^48]

[^48]: [outputs/data/o-group_assoc-prof_unitoccs_summary_pay.csv](https://github.com/Project-X-UK/jrf_nat_rep/blob/main/outputs/data/o-group_assoc-prof_unitoccs_summary_pay.csv)
...
[^49]: [outputs/data/prof_unitoccs_summary_pay.csv](https://github.com/Project-X-UK/jrf_nat_rep/blob/main/outputs/data/prof_unitoccs_summary_pay.csv)
...
Examining by outsourcing group indicates that the outsourced group is the main driver of lower pay in the identified unit occupations.[^50]

[^50]: [outputs/data/o-group_prof_unitoccs_summary_pay.csv](https://github.com/Project-X-UK/jrf_nat_rep/blob/main/outputs/data/o-group_prof_unitoccs_summary_pay.csv)
...
For this major occupation group, the notable differences in pay are in 'Caring Personal services and 'Teaching and Childcare Support Occupations'.[^51]

[^51]: [outputs/data/caring_unitoccs_summary_pay.csv](https://github.com/Project-X-UK/jrf_nat_rep/blob/main/outputs/data/caring_unitoccs_summary_pay.csv)
...
Breaking down by outsourcing group shows that the outsourced and likely agency groups are paid less than non-outsourced workers. In contrast, for 'Caring Personal Services', workers in the 'high indicators' group tend to be paid more than non-outrsourced people (though note n = 13).[^52]

[^52]: [outputs/data/o-group_caring_unitoccs_summary_pay.csv](https://github.com/Project-X-UK/jrf_nat_rep/blob/main/outputs/data/o-group_caring_unitoccs_summary_pay.csv)
...
Again, the outsourced group is the main driver of lower pay.[^54]

[^54]: [outputs/data/o-group_process_unitoccs_summary_pay.csv](https://github.com/Project-X-UK/jrf_nat_rep/blob/main/outputs/data/o-group_process_unitoccs_summary_pay.csv)
