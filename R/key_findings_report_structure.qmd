...
data$Ethnicity_collapsed_disaggregated <- data$Ethnicity_collapsed
...
::: {.callout-important title="#how-many"}
...
Comparison of ethnicities indicates that some groups are statistically more likely to be outsourced than others[^16]:

[^16]: [outputs/data/ethnicity_model_inferential.csv](https://github.com/JustKnowledge-UK/jrf_nat_rep/blob/main/outputs/data/ethnicity_model_inferential.csv)
...
::: {.callout-tip title='#ethnicity-disaggregated'}
...
Comparison of more disaggregated ethnicities indicates more nuance^[[outputs/data/ethnicity_model_inferential_2.csv](https://github.com/JustKnowledge-UK/jrf_nat_rep/blob/main/outputs/data/ethnicity_model_inferential_2.csv)]:

-   White other workers are `r coef_table["Ethnicity_collapsed_disaggregatedWhite other", "or"]` times more likely than White workers to be outsourced.
-   Black African workers are `r coef_table["Ethnicity_collapsed_disaggregatedBlack African", "or"]` times more likely than White workers to be outsourced.
-   Mixed other workers are `r coef_table["Ethnicity_collapsed_disaggregatedMixed other", "or"]` times more likely than White workers to be outsourced.
-   South Asian workers are `r coef_table["Ethnicity_collapsed_disaggregatedSouth Asian", "or"]` times more likely than White workers to be outsourced.
-   Other workers are `r coef_table["Ethnicity_collapsed_disaggregatedOther", "or"]` times more likely than White workers to be outsourced.
-   Black other workers are `r coef_table["Ethnicity_collapsed_disaggregatedBlack other", "or"]` times more likely than White workers to be outsourced.
-   Arab workers are `r coef_table["Ethnicity_collapsed_disaggregatedArab", "or"]` times more likely than White workers to be outsourced.

Black Caribbean and East Asian workers are no more or less likely than White workers to be outsourced.
...
[^17]: [outputs/data/ethnicity_ogroup_inferential_tab.csv](https://github.com/JustKnowledge-UK/jrf_nat_rep/blob/main/outputs/data/ethnicity_ogroup_inferential_tab.csv)
...
More nuance from disaggregated ethnicities^[[outputs/data/ethnicity_ogroup_inferential_tab_2.csv](https://github.com/Project-X-UK/jrf_nat_rep/blob/main/outputs/data/ethnicity_ogroup_inferential_tab_2.csv)]. Compared to White British workers,
...
Again, Black Caribbean and East Asian workers are no more or less likely than White British workers to be engaged in any type of outsourced work.

:::{.callout-important title='#ethnicity-pay-split TO DO'}
...
[^18]: [outputs/data/arrival_in_UK_stats.csv](https://github.com/JustKnowledge-UK/jrf_nat_rep/blob/main/outputs/data/arrival_in_UK_stats.csv)

[^19]: [outputs/data/bornuk_ostatus_inferential_tab.csv](https://github.com/JustKnowledge-UK/jrf_nat_rep/blob/main/outputs/data/bornuk_ostatus_inferential_tab.csv)
...
[^23]: [outputs/data/bornUK_binary_contrasts.csv](https://github.com/JustKnowledge-UK/jrf_nat_rep/blob/main/outputs/data/bornUK_binary_contrasts.csv)
...
Similarly, the plot below shows that[^24]

[^24]: [outputs/data/region_stats_2.csv](https://github.com/JustKnowledge-UK/jrf_nat_rep/blob/main/outputs/data/region_stats_2.csv)
...
:::{.callout-important title='#sectors'}
...
[^11]: [outputs/data/gender_outsourced_gap.csv](https://github.com/JustKnowledge-UK/jrf_nat_rep/blob/main/outputs/data/gender_outsourced_gap.csv) & [outputs/data/mod_gender_outsourcing.csv](outputs/data/mod_gender_outsourcing.csv)
