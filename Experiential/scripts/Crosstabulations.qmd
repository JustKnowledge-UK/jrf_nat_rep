...
-   [x] Morgan provide a list of the final set of variables of interest
-   [x] The list has been reduced from 172 variables to 88 but its probably still took long. Cel to reduce using Chi2 tests
