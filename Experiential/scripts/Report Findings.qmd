...
[Data processing explanation placeholder]
...
rights_summary <- rights_data %>%
  ...
  {cat("Number of rights violation variables selected:", ncol(.), "(should be 7)\n"); .} %>%
  ...
  {cat("Maximum num_neg:", max(.$num_neg, na.rm = TRUE), "(should be ≤ 7)\n\n"); .} %>%
