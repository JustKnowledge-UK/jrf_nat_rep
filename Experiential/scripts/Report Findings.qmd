...
This analysis examines reported experiences of sex-based discrimination among outsourced workers, comparing prevalence rates across demographic groups and employment characteristics. The analysis employs descriptive statistics to document discrimination frequencies and conducts cross-tabulations with key variables to identify patterns of differential treatment. Statistical tests assess the significance of observed associations, with particular attention to intersectional effects where sex-based discrimination may compound with other forms of disadvantage.
...
This analysis examines reported experiences of ethnicity-based discrimination among outsourced workers, comparing prevalence rates across different ethnic groups and employment characteristics. The analysis employs descriptive statistics to document discrimination frequencies and conducts cross-tabulations with key demographic variables to identify patterns of differential treatment. Statistical tests assess the significance of observed associations, with particular attention to how ethnicity-based discrimination may intersect with other forms of disadvantage in outsourced work environments.
...
\[Analysis explanation placeholder\]
